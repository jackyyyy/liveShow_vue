...
export default {
  data () {
    return {
      menuItem: [{name: '大司马', url: '/UserInfo'}, {name: '选择语言', url: '/Home'}, {name: '分类', url: '/Category'}, {name: '历史记录', url: '/History'}, {name: '购买虚礼货币', url: '/Recharge'}, {name: '完整版', url: '/Home'}, {name: '帮助', url: '/Home'}, {name: '新增', url: '/AddPage'}],
